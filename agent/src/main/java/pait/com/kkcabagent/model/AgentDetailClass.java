package pait.com.kkcabagent.model;

import java.io.Serializable;

public class AgentDetailClass implements Serializable {

    private int registerValidFlag;
    private String userName, emailId, mobileNo, firmName, city, imeiNo,
            userid, OTP, expiryDate, startDate, userType, lastBackup, lastRestore,
            imgName, macAddress, fName, lName, agencyName, agentName;
